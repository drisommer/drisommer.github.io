...
/*--------------------------------------------------
Function Project Video Modal
---------------------------------------------------*/	
	
	window.ProjectVideoModal = function() {
		
		// Only run if there are play-project-video elements
		if( $('.is-project-video').length > 0 ){
			
			// Append modal structure to body once
			if($('.clapat-video-modal').length === 0) {
				$('body').append(`
					<div class="clapat-video-modal">
						<div class="clapat-video-modal-bg"></div>
						<div class="clapat-video-container">
							<div class="button-wrap clapat-video-modal-close">
			...
			// Elements
			const modal = $('.clapat-video-modal');
			...
			$(".play-project-video").mouseenter(function(e) {	
				gsap.to('#ball', {duration: 0.2, borderWidth: '2px', scale: 1.4, borderColor:"rgba(255,255,255,0)", backgroundColor:"rgba(255,255,255,0.1)"});
				gsap.to('#ball-loader', {duration: 0.2, borderWidth: '2px', top: 2, left: 2});
				$("#ball").addClass("with-blur");
				$( "#ball" ).append( '<p class="center-first">Play</p>' );
			});
				
			$(".play-project-video").mouseleave(function(e) {	
				gsap.to('#ball', {duration: 0.2, borderWidth: '4px', scale:0.5, borderColor:'#999999', backgroundColor:'transparent'});
				gsap.to('#ball-loader', {duration: 0.2, borderWidth: '4px', top: 0, left: 0});
			...
			// Open modal on click
			$('#itemsWrapperLinks .trigger-item-link, #itemsWrapperLinks .trigger-item-link-secondary').on('click', function(e) {
			//$('.play-project-video').on('click', function(e) {
				e.preventDefault();
				e.stopPropagation();
				
				// Get video URL from data attribute
				const videoUrl = $(this).data('project-video');
				...
				gsap.to(modal, {duration: 0.3, opacity: 1});
				gsap.to(modalBg, {duration: 0.3, opacity: 1});
			...
			$('.clapat-video-modal-close, .video-close-wrapper').on('click', closeModal);
		...
		// Style video close button on hover
			$(".clapat-video-modal-close").mouseenter(function(e) {	
				gsap.to('#ball', {duration: 0.2, borderWidth: '2px', scale: 1.4, borderColor:"rgba(255,255,255,0)", backgroundColor:"rgba(255,255,255,0.1)"});
				gsap.to('#ball-loader', {duration: 0.2, borderWidth: '2px', top: 2, left: 2});
				$("#ball").addClass("with-blur");
				$( "#ball" ).append( '<p class="center-first">Close</p>' );
			});
				
			$(".clapat-video-modal-close").mouseleave(function(e) {	
				gsap.to('#ball', {duration: 0.2, borderWidth: '4px', scale:0.5, borderColor:'#999999', backgroundColor:'transparent'});
				gsap.to('#ball-loader', {duration: 0.2, borderWidth: '4px', top: 0, left: 0});
				$("#ball").removeClass("with-blur");
				$('#ball p').remove();
			...
			// Video Modal Close Button Hover Effects for parallax
			$(".clapat-video-modal-close .parallax-wrap").mouseenter(function(e) {
				gsap.to(ball, { duration: 0.3, borderColor:$("body").data('primary-color')  });
				gsap.to(this, { duration: 0.3, scale: 0.9 });
				gsap.to($( this ).children(), {duration: 0.3, scale:0.9});
				active = true;
			});
			
			$(".clapat-video-modal-close .parallax-wrap").mouseleave(function(e) {
				gsap.to(this, { duration: 0.3, scale: 1 });
				gsap.to(ball, { duration: 0.3, scale: 0.5, borderWidth: '4px', opacity:1, borderColor:'#999999'  });
				gsap.to($( this ).children(), {duration: 0.3, scale:1, x: 0, y:0});
				active = false;
